...
public class ImageLoader {
    ...
    private BufferedImage leftoverImage;
    ...
    private void loadAllImages() {
        ...
        leftoverImage = loadImage("/entity/collectible/leftovers_v5.png", true);
    }
