...
public class CollisionTest {
    ...
    void testMovePlayerUp() {
        Player player = new Player(gamePanel.getImageLoader().getPlayerImages(), 0, 0, 0, Move.UP);
        gamePanel.getMapManager().loadMap("/maps/world_map.txt");
    ...
    void testMovePlayerDown() {
        Player player = new Player(gamePanel.getImageLoader().getPlayerImages(), 0, 0, 0, Move.DOWN);
        gamePanel.getMapManager().loadMap("/maps/world_map.txt");
    ...
    void testMovePlayerLeft() {
        Player player = new Player(gamePanel.getImageLoader().getPlayerImages(), 0, 0, 0, Move.LEFT);
        gamePanel.getMapManager().loadMap("/maps/world_map.txt");
    ...
    void testMovePlayerRight() {
        Player player = new Player(gamePanel.getImageLoader().getPlayerImages(), 0, 0, 0, Move.RIGHT);
        gamePanel.getMapManager().loadMap("/maps/world_map.txt");
    ...
    void testNextDirection() {
        Raccoon enemy = new Raccoon(gamePanel.getImageLoader().getEnemyRacoonImages(), 100, 100, 0, Move.RIGHT, 0, 0, 0);
